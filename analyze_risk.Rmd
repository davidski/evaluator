...
scenario_summary$outlier <- scenario_summary$ale_var > sd(scenario_summary$ale_var) * 2
...
gg <- gg + scale_color_discrete(guide = guide_colorbar())
gg <- gg + scale_x_reverse(labels = percent)
gg <- gg + theme_evaluator(base_family = "Helvetica")
