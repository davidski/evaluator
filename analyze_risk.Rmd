...
`r percent(loss_exceedance[loss_exceedance$tolerance == "High", ]$n /
max(results$simulation))` of the time.
...
The top scenarios as measured by a standard finance 95% Value at Risk (VaR) 
calculation are:
