...
<!-- index.Rmd is used only of pkgdown, edit README.Rmd for GitHub's README --->
...
# Evaluator <img alt="Evaluator Logo" title="Evaluator" align="right" src="evaluator_logo.jpg" width="100" style="float:right;width:100px;"/>
...
Three sample outputs of this toolkit are:
