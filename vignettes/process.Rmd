...
toolkit. This vignette details the basic flow used at some organizations. While 
other technologies and solutions may be employed, this workflow is both 
lightweight and relatively easy to implement for users familiar with source 
control principles.
