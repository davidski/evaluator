...
`generate_report(input_directory = "~/data", results_directory = "~/results")`.
...
evaluator::summarize_all(simulation_results = simulation_results, domains = domains)
...
# Sample Report
generate_report(input_directory = "data", results_directory ="results") %>% rstudioapi::viewer()
```
