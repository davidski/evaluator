...
comma-seperated file defining the domains used in the survey tool, and a file 
...
save two comma seperated files in the `inputs` directory with the results. 
...
`generate_report("~/evaluator/inputs", "~/evaluator/results", "~/evaluator/risk_report.docx", output_format = "word_document")`.
