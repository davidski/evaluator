...
output: 
  flexdashboard::flex_dashboard:
    ...
    source_code: embed
    favicon: !expr system.file('rmd', 'img', 'evaluator_logo_48px.png', package = 'evaluator')
    logo: !expr system.file("rmd", "img", "evaluator_logo_48px.png", package = "evaluator")
    navbar:
    - align: right
      href: https://github.com/davidski/evaluator
      title: About
      css: !expr system.file("rmd", "styles", "html-styles.css", package = "evaluator")
---
