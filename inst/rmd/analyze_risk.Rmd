...
scenario_summary <- mutate(scenario_summary, 
...
generate_event_outcomes_plot(domain_summary_new)
```
...
filter(scenario_summary, outlier == TRUE) %>% 
  ...
  rename("Scenario ID" = full_label, "Description" = scenario_description, 
         "Value at Risk" = ale_var,
...
generate_heatmap(domain_summary_new)
```
