...
risk report. Assuming that the input files have been placed in an `inputs` 
...
risk_tolerances <- read_csv("~/evaluator/inputs/risk_tolerances.csv")

# Explorer
explore_scenarios("~/evaluator/inputs", "~/evaluator/results")

# Sample Report
generate_report("~/evaluator/inputs", "~/evaluator/results") %>% rstudioapi::viewer()
```
...
to find he location of the native template on your system.
