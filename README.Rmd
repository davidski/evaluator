...
Install Evaluator via the standard CRAN mechanisms. To run the default, but 
optional, report functions, use the `dependencies = TRUE` flag to pull in the 
additional packages needed for reporting.
