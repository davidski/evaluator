...
> This report is based on `r comma(attr(results, "simulation_count"))` 
...
The top three information security program with the largest likely losses are 
`r domain_impact[[1, "domain"]]`, `r domain_impact[[2, "domain"]]`, and 
